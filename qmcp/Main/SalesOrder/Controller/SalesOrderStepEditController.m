//
//  SalesOrderStepEditController.m
//  qmcp
//
...
#import "Helper.h"
#import "SalesOrder.h"
@interface SalesOrderStepEditController ()<UINavigationControllerDelegate, UIImagePickerControllerDelegate,UIActionSheetDelegate,
...
@implementation SalesOrderStepEditController
...
-(void)loadData
{
    ...
    NSString *stepWhere = [NSString stringWithFormat:@"id = '%@'",_stepId];
...
+(instancetype)doneBlock:(void (^)(WorkOrderStep *,SaveType type))block{
    ...
    SalesOrderStepEditController *vc = [[SalesOrderStepEditController alloc] init];
    vc.doneBlock = block;
    return vc;
