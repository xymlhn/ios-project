...
@interface GisViewController ()<MKMapViewDelegate,CLLocationManagerDelegate>
{
    MKMapView *_mapView;
...
- (void)viewDidLoad {
    ...
    NSNotification * notice = [NSNotification notificationWithName:@"logout" object:nil userInfo:nil];
    //发送消息
